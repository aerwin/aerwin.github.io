...
In my previous post [_Redirecting HTTP to HTTPS with Node.js &amp; Express on IBM Bluemix_](http://www.tonyerwin.com/2014/09/redirecting-http-to-https-with-nodejs.html){:target="_blank"}, I described how you automatically get basic SSL support if you use the default domain when configuring your apps to run on [IBM Bluemix](https://www.bluemix.net/){:target="_blank"}. However, if you use a custom domain, you'll get domain mismatch errors in the browser. These errors are ugly and likely to scare away users. In this post, I'll show you how to fix this problem by associating your own SSL certificate with your custom domain. This new functionality went live in the [August 2014 refresh](http://www.tonyerwin.com/2014/09/bluemix-ui-updates-august-2014.html){:target="_blank"} of the Bluemix UI. Along the way, you'll learn how to do the following:
